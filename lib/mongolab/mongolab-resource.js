angular.module('mongolabResource', []).factory('mongolabResource', ['MONGOLAB_CONFIG','$http', 'jsonFilter', function (MONGOLAB_CONFIG, $http, jsonFilter) {
  ...
  function MongolabResourceFactory(collectionName) {
    ...
    var defaultParams = {apiKey:MONGOLAB_CONFIG.apiKey};
